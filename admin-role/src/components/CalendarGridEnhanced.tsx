...
export function CalendarGridEnhanced({ onAddBooking, onNavigateToClient }: CalendarGridEnhancedProps) {
  ...
  // Resources from tech spec
  const resources = [
    { id: 'anna', name: 'Анна' },
    { id: 'maria', name: 'Мария' }
  ];

  // Generate time slots (every 30 minutes from 9:00 to 20:00) - exact as tech spec
  ...
  // Demo bookings from tech spec exactly
  const bookings: BookingBlock[] = [
    // Resource A (Анна) - точно как в техзадании
    {
      id: 'booking-1',
      resourceId: 'anna',
      startTime: '09:00',
    ...
    // Resource B (Мария) - точно как в техзадании
    {
      id: 'booking-4',
      resourceId: 'maria',
      startTime: '10:00',
  ...
  // Get booking span (how many slots it covers) - height calculation as per tech spec
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-6">
      ...
      {/* Calendar Grid with exact tech spec layout */}
      <Card className="clean-card overflow-hidden" style={{ borderRadius: '20px' }}>
        <div className="overflow-x-auto">
          <div className="min-w-[800px]">
            {/* Header Row - Time | Resource A | Resource B */}
            <div className="grid grid-cols-[120px_1fr_1fr] gap-0 border-b border-border">
            ...
            {/* Time Slots - 30 min step, 56px height as per tech spec */}
            <div className="grid grid-cols-[120px_1fr_1fr] gap-0">
              {timeSlots.map((timeSlot) => (
                <React.Fragment key={timeSlot}>
                  {/* Time Label */}
                  <div 
                    className="border-b border-border bg-muted/20 flex items-center justify-center" 
                    style={{ height: '56px' }} // Exact height from tech spec
                  >
                    <div className="flex items-center gap-2">
                  ...
                  {resources.map((resource) => {
                    ...
                    return (
                      <div
                        ...
                        `}
                        style={{ height: '56px' }} // Exact 56px height
                      ...
                      >
                        ...
                        {booking && isStart && (
                          <div 
                            ...
                            `}
                            style={{
                              height: `${getBookingSpan(booking) * 56 - 8}px`, // Height = 56px × (duration/30)
                              minHeight: '48px'
                            }}
                            onClick={(e) => {
                              e.stopPropagation();
                        ...
                        {/* Add Button - opacity 0% → hover 100% as per tech spec */}
                        {!booking && (
      ...
      {/* Legend - exactly as per tech spec */}
      ...
      <BookingDetailsDrawer
        ...
        booking={selectedBooking ? {
          ...
          price: 2500, // Mock data
          notes: 'Демонстрационная запись', // Mock data
